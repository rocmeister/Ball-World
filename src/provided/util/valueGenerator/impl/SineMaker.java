...
import provided.util.valueGenerator.ISineMaker;
...
public class SineMaker implements ISineMaker {
	...
	/* (non-Javadoc)
	 * @see provided.util.valueGenerator.ISineMaker#getDblVal()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see provided.util.valueGenerator.ISineMaker#getIntVal()
	 */
	@Override
