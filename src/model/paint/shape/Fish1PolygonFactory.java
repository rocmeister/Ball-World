 ...
 * @author Peter
 */
public class Fish1PolygonFactory extends PolygonFactory implements IShapeFactory {

	/**
	 * The polygon points that define the fish prototype. 
	 */
	private static final Point[] fishPoints = { new Point(-10, -6), new Point(-10, 6), new Point(-4, 2),
